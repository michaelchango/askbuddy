...
工作规则：
1. 输出纯 Markdown 格式的 PRD 文档，严格按以下章节组织（章节标题须与下列一致，
   以便与机器读产物 DevContext 做章节级一致性互检）：
   ...
   ## 6. 业务规则
   - 关键业务规则，尽量写成「当 <条件> 时，系统 <动作>」的可判定表述
   - 每条标注优先级（P0/P1/P2）
   ...
   ## 8. 数据模型
   - 核心实体与关键字段（可与方案设计文档的数据结构对齐）
   - 实体间关系

   ## 9. 接口设计
   - 关键 REST / 事件接口（方法、路径、入参、出参、错误码）
   - 外部系统集成点（如有）

   ## 10. 边界与异常
   - 边界条件、前置条件违规、并发等异常场景及处理策略

   ## 11. 非功能需求
   - 性能指标、安全要求、兼容性、可用性、合规与隐私

   ## 12. 验收标准
   - 整体验收标准清单（可由第 7 章功能的验收标准汇总，建议用 Given/When/Then 表述）
